...
function AboutParagraph({ className }: React.HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    <div className={cn("flex flex-col gap-4 opacity-80 ", className)}>
      <p>
        I&apos;m Augustas. I build full stack websites that look good and work
        smoothly. I love clean, animated UIs, and I&apos;m also comfortable with
        complex backend logic to keep things fast and modern.
      </p>
      {showMore && (
        <>
          <p>
      ...
      <p>
        ...
        something used by millions. If you need a passionate developer on your
        team, let&apos;s chat and bring your idea to life.
      </p>
